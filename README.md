...
This a coding challenge published in [GreatFrontEnd](https://www.greatfrontend.com) platform and it's main task is to implement a reusable, responsive card that will be used as a building block in blogs. This implementation
